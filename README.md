...
- `*.ass` – generated subtitle files (ignored by git; create your own locally via the exporter).
- `venv/` – optional local virtual environment (ignored by git; create as needed).
